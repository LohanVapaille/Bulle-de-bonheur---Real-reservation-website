...
Sur simple demande (sans supplément) : siège massant et ceinture de massage pour les cervicales.</p>
  ...
  <section class="blog-section">
    ...
    <div class="blog-text fade-in-up-on-scroll">
      ...
      <ul>
    <li>•   Planche apéro salée (charcuterie, fromage) + boisson : 30 € pour 2 personnes</li>
	<li>•	Planche sucrée (gaufres, muffins, glace minute…) + boisson : 25 € pour 2 personnes</li>
</ul>
    </div>
  </section>
  ...
  <section class="blog-section">
    <div class="blog-img fade-in-up-on-scroll">
      <img  loading='lazy' src="https://www.actionenfance.org/wp-content/uploads/droits-des-enfants.jpg" alt="enfants">
    </div>
    <div class="blog-text fade-in-up-on-scroll">
